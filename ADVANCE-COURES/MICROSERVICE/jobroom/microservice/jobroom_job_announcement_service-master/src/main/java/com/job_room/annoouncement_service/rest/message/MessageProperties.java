...
public class MessageProperties {
    ...
    public String shared(String resourceName){
        return accessor.getMessage("message.shared", new Object[] {resourceName});
    }

    public String unshared(String resourceName){
        return accessor.getMessage("message.unshared", new Object[] {resourceName});
    }

    public String draft(String resourceName){
        return accessor.getMessage("message.draft", new Object[] {resourceName});
    }

    public String undraft(String resourceName){
        return accessor.getMessage("message.undraft", new Object[] {resourceName});
    }
